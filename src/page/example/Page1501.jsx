    ...
    <div className="card height-01">
      ...
      <div className="hugreen_grid flex-1 flex flex-wrap md:flex-row">
        ...
        <div className="hugreen_aggridbtn_hwrap">
            ...
            <div className="flex gap-2"> 
              <Button label="등록 - 모달임시용" className="btn-28-master" severity="secondary" outlined onClick={() => setVisible3(true)}/>
              <Dialog
                  header="등록"
                  visible={visible3}
                  modal={false}
