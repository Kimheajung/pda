    ...
    <div className="card height-01">
      ...
      <div className="hugreen_grid flex-1 flex flex-wrap md:flex-row">
        ...
        <div className="hugreen_aggridbtn_hwrap">
            ...
            <div className="flex gap-2"> 
            <Button label="상세보기 임시용모달" className="btn-28-master" severity="secondary" outlined onClick={() => setVisible3(true)}/>
            <Dialog
                header="업체 상세조회"
                visible={visible3}
                modal={false}
                ...
                <div className="flex w-full" style={{ height: '40vh' }}>
                    <div className="dtv-info-grid">
                        ...
                        <div className="row">
                         ...
                         <div className="row">
                            <div className="th">기성사용여부</div>
                            <div className="td">
                                <Dropdown value={selectedCity} className='w-28' onChange={(e) => setSelectedCity(e.value)} options={cities} optionLabel="name" 
                                placeholder="선택해주세요"/> 
                            </div>
                             <div className="th">조회여부</div>
                            <div className="td">
                                <Dropdown value={selectedCity} className='w-28' onChange={(e) => setSelectedCity(e.value)} options={cities} optionLabel="name" 
                                placeholder="선택해주세요"/> 
                            </div>
