      ...
      <div className="grid-searchwrap grid-searchwrap--6col">
        <div className="row">
          ...
          <div className="td gap-2">
            ...
            <label htmlFor="ingredient1">현재일기준 </label>
            </div>
            <div className="flex align-items-center">
    ...
    <div className="card height-01">
      ...
      <div className="hugreen_grid flex-1 flex flex-wrap md:flex-row">
        ...
        <div className="hugreen_aggridbtn_hwrap">
            ...
            <div className="flex gap-2"> 
                <span className="dc-label">DC사용률</span>
                <div className="dc-warn">
                    <span className="dc-icon dc-green"></span>
                    <span className="dc-label">양호 (50% 미만)</span>
                </div>
                <div className="dc-warn">
                    <span className="dc-icon dc-yellow"></span>
                    <span className="dc-label">50~70%</span>
                </div>
                <div className="dc-warn">
                    <span className="dc-icon dc-red"></span>
                    <span className="dc-label">70%초과</span>
                </div>
            </div>
        </div>
        {/* 공통 : ag그리드  */}
