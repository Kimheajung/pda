    ...
    <div className="card height-01">
      ...
      <div className="hugreen_grid flex-1 flex flex-wrap md:flex-row">
        ...
        <div className="hugreen_aggridbtn_hwrap">
            ...
            <div className="flex gap-2"> 
            <Button label="상세보기 임시용모달" className="btn-28-sec" severity="secondary" outlined onClick={() => setVisible3(true)}/>
            <Dialog
                header="사용자 상세정보"
                visible={visible3}
                modal={false}
                    ...
                    <div className="dtv-info-grid">
                        ...
                        <div className="row">
                            ...
                            <div className="td flex-wrap">
                                 <span className="notice point2"> * 비밀번호 변경시 입력해 주세요.</span>
                                <InputText value={value}  onChange={(e) => setValue(e.target.value)}  placeholder=""/> 
                            </div>
                            <div className="th">비밀번호 확인</div>
                            <div className="td flex-wrap">
                                 <span className="notice point2"> * 다시한번 입력해주세요.</span>
                                <InputText value={value}  onChange={(e) => setValue(e.target.value)}  placeholder=""/> 
                            </div>
                        </div>
            ...
            <Button label="등록-모달잇음" className="btn-28-master" severity="secondary" outlined onClick={() => setVisible2(true)}/>
                <Dialog
                header="사용자등록"
                visible={visible2}
                modal={false}
