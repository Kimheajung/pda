    ...
    <div className="card height-01">
      ...
      <div className="hugreen_grid flex-1 flex flex-wrap md:flex-row">
        ...
        <div className="hugreen_aggridbtn_hwrap">
            ...
            <div className="flex gap-2"> 
            <Button label="제품추가 - 임시용 모달 잇음" className="btn-28-sec" severity="secondary" outlined onClick={() => setVisible3(true)}/>                
            ...
            <Dialog
                ...
                <div className="flex flex-wrap w-full">
                    ...
                    <div className="flex">
                        <span className="NumText"> 조회결과</span>
                        <p class="totalNumText">
                        총&nbsp;<span>18,203</span>건
                        </p>
                    </div>
                    {/*  필요시 */}
                    <div className="flex gap-2">
