          ...
          <div className="hugreen_mobile_wrap">
            ...
            <div className="grid-searchwrap grid-searchwrap--4col">
                ...
                <div className='td gap-2'>
                        <InputText value={value} className="w-full" onChange={(e) => setValue(e.target.value)}  placeholder="P160224050"/>
                        {/* 오른쪽 : 펼치기 / 숨기기 버튼 */}
                        <Button
                        text
                ...
                <div
                    ...
                    <div className="td gap-2">
                    <InputText value={value} className="w-full" onChange={(e) => setValue(e.target.value)}  placeholder="PBF-120B"/>
                    </div>
                    <div className="th">규격</div>
                    <div className="td gap-2">
                    <InputText value={value} className="w-full" onChange={(e) => setValue(e.target.value)}  placeholder="W681, 넓은"/>
                    <InputText value={value} className="w-38" onChange={(e) => setValue(e.target.value)}  placeholder="5500160"/>
                    </div>
                    <div className="th">재고</div>
                    <div className="td gap-2">
                    <InputText value={value} className="w-full" onChange={(e) => setValue(e.target.value)}  placeholder="99"/>
                    </div>
                    <div className="th">병합재고</div>
                    <div className="td">
                    <InputText value={value} className="w-full" onChange={(e) => setValue(e.target.value)}  placeholder="99"/>
                    </div>
                    <div className="th">작업수량</div>
                    <div className="td">
                    <InputText value={value} className="w-full" onChange={(e) => setValue(e.target.value)}  placeholder="99"/>
                    </div>
