...
const [activeLeftMenu, setActiveLeftMenu] = useState(null);
  ...
  const menu = [
    ...
    },
    {
      label: '출고',
      items: [
        { label: '생산투입대상조회', icon: '', to: '/in04' },
        { label: '생산투입', icon: '', to: '/in04' },
        { label: '생산투입내역조회', icon: '', to: '/in04' },
        { label: '판매출고', icon: '', to: '/in05' },
        { label: '판매출고내역조회', icon: '', to: '/in05' },
      ],
    },
    {
      label: '기타',
      items: [
        { label: '기타출고', icon: '', to: '/in06' },
        { label: '재고변경', icon: '', to: '/in08' },
        { label: '재고이동', icon: '', to: '/in09' },
        { label: '재고실사계획조회', icon: '', to: '/in07' },
        { label: '재고실사등록', icon: '', to: '/in07' },
        { label: '팔렛병합', icon: '', to: '/in10' },
        { label: '팔렛정보조회', icon: '', to: '/in11' },
        { label: '제품검수', icon: '', to: '/in12' },
      ],
    },
    // ... 필요 메뉴 그대로 복사
  ];
