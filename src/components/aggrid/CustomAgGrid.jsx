...
if (import.meta.env.MODE === "development") {
  ...
  import('ag-grid-enterprise').then(() => {
    import('ag-grid-enterprise').then(
      ({ LicenseManager, AllEnterpriseModule }) => {
        try {
          ...
          import('ag-grid-community').then(({ ModuleRegistry }) => {
            ModuleRegistry.registerModules([AllEnterpriseModule]);
          });
        } catch (e) {
          console.error("AG Grid Enterprise INIT ERROR:", e);
        }
      }
    );
  });
} else {
  console.log("AG Grid ENTERPRISE DISABLED (Production / GitHub Pages)");
}
